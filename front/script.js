...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsEmployeeList = __webpack_require__(1);

	var _componentsEmployeeList2 = _interopRequireDefault(_componentsEmployeeList);

	_react2['default'].render(_react2['default'].createElement(_componentsEmployeeList2['default'], null), document.getElementById('content'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _storesEmployeeStore = __webpack_require__(3);

	var _storesEmployeeStore2 = _interopRequireDefault(_storesEmployeeStore);

	var _actionsEmployeeActions = __webpack_require__(4);

	var _actionsEmployeeActions2 = _interopRequireDefault(_actionsEmployeeActions);
	...
	var EmployeeList = (function (_React$Component) {
	    ...
	    function EmployeeList(props) {
	        ...
	        this.state = { employees: _storesEmployeeStore2['default'].getState() };
	    ...
	    _createClass(EmployeeList, [{
	        ...
	        value: function _onChange() {
	            console.log(_storesEmployeeStore2['default'].getState());
	            this.setState({
	                employees: _storesEmployeeStore2['default'].getState()
	            });
	        }
	    }, {
	        key: 'componentDidMount',
	        value: function componentDidMount() {
	            _storesEmployeeStore2['default'].listen(this._onChange);
	            _actionsEmployeeActions2['default'].fetchEmployees();
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sourcesEmployeeSource = __webpack_require__(7);

	var _sourcesEmployeeSource2 = _interopRequireDefault(_sourcesEmployeeSource);

	var EmployeeStore = (function () {
	    function EmployeeStore() {
	        _classCallCheck(this, EmployeeStore);

	        this.bindActions(_actionsEmployeeActions2['default']);
	        this.state = [];
	    }

	    _createClass(EmployeeStore, [{
	        key: 'onUpdateEmployees',
	        value: function onUpdateEmployees(employees) {
	...
	exports['default'] = _alt2['default'].createStore(EmployeeStore);
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EmployeeActions = (function () {
	    function EmployeeActions() {
	        _classCallCheck(this, EmployeeActions);

	        this.generateActions(['updateEmployees']);
	    }

	    _createClass(EmployeeActions, [{
	        key: 'fetchEmployees',
	        value: function fetchEmployees() {
	            var _this = this;

	            this.dispatch();
	            _sourcesEmployeeSource2['default'].fetch().then(function (employees) {
	                _this.actions.updateEmployees(new _immutable.List(employees));
	            })['catch'](function (errorMsg) {
	                _this.actions.employeesFailed(errorMsg);
	            });
	        }
	    }, {
	        key: 'employeesFailed',
	        value: function employeesFailed(errorMsg) {
	...
	exports['default'] = _alt2['default'].createActions(EmployeeActions);
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = {
	    fetch: (function (_fetch) {
	        ...
	        return fetch(_config.apiUrl).then(function (response) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var apiUrl = 'http://127.0.0.1:8083/api';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _flux = __webpack_require__(146);

	var _utilsStateFunctions = __webpack_require__(98);

	var StateFunctions = _interopRequireWildcard(_utilsStateFunctions);

	var _utilsFunctions = __webpack_require__(99);
	...
	var _utilsAltUtils = __webpack_require__(100);
